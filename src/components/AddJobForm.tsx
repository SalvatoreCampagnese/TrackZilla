        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className={`text-xs sm:text-sm ${
                step === 'details' ? 'text-red-600 font-medium' : 'text-muted-foreground'
              }`}>
                Details
              </span>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <Textarea
                  ...
                  className="mt-2 min-h-[150px] sm:min-h-[200px] bg-background border-border text-foreground resize-none focus-visible:ring-red-500 focus-visible:border-red-500"
                  required
                  autoFocus
                  onFocus={(e) => {
