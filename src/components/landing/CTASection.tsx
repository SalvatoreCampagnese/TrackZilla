  ...
  return <section className="py-16 sm:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gray-900 rounded-2xl px-6 sm:px-12 py-12 sm:py-16 text-center border border-gray-800">
          ...
          <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto text-zinc-100">
          ...
          <Button onClick={onGetStarted} size="lg" className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 text-lg rounded-full">
