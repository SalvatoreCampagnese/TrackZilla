  ...
  return <section className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-12">
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="max-w-2xl animate-fade-in">
          ...
          <p className="text-xl text-white/80 mb-8 max-w-lg leading-relaxed font-light underline ">Job hunt got you feeling like you're fighting a <a className="text-red-500 underline" href="https://www.youtube.com/watch?v=YQX2CsMCB9M" target="_blank">Gila monster</a> with a spoon?</p>
