...
export const FeaturesSection: React.FC = () => {
  ...
  const features = [
    { icon: Target, key: 'track', color: "red" },
    { icon: TrendingUp, key: 'analytics', color: "blue" },
    { icon: Clock, key: 'followUps', color: "purple" },
    { icon: BarChart3, key: 'dashboard', color: "orange" },
    { icon: CheckCircle, key: 'statuses', color: "green" },
    { icon: Zap, key: 'summon', color: "indigo" }
  ];
