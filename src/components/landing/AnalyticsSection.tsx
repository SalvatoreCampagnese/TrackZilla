        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 animate-slide-up">
            <div className="card-modern p-4 rounded-3xl">
              <img
                alt="Illustration of two monsters facing off, symbolizing challenges in the job search process"
                className="w-full h-64 sm:h-80 lg:h-96 object-cover rounded-2xl shadow-xl hover:scale-105 transition-transform duration-500"
          ...
          <div className="order-1 lg:order-2 animate-fade-in">
            ...
            <p className="text-xl text-white/70 mb-8 leading-relaxed font-light">
              TrackZilla gives you detailed insights into your response rates,
              helps you spot success patterns, and optimizes your job hunting
              strategy. It's like having analytics superpowers for your career!
              📊
            </p>
            ...
            <Button
              ...
              size="lg"
              className="bg-white text-gray-900 hover:bg-white/90 px-8 py-4 rounded-2xl font-semibold shadow-2xl transition-all duration-300 hover:scale-105"
            >
