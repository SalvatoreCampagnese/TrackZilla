...
export const KanbanCard: React.FC<KanbanCardProps> = ({
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-md border border-white/30 shadow-lg transition-all duration-200 hover:shadow-xl cursor-grab active:cursor-grabbing touch-manipulation select-none rounded-lg p-3 md:p-4 ${
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="text-red-500 hover:text-red-700 hover:bg-red-50 h-5 w-5 md:h-6 md:w-6 p-0 flex-shrink-0 ml-2 touch-manipulation cursor-pointer"
        >
