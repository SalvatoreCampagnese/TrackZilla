...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return <header className="sticky top-0 z-30 backdrop-blur-xl bg-black/30 border-b border-white/10 shadow-lg">
      <div className="flex items-center justify-between p-3 sm:p-4 lg:p-6">
        ...
        {activeTab === 'applications' && <Button onClick={onAddApplication} className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 text-white shadow-lg hover:shadow-xl hover:scale-105 rounded-xl px-3 sm:px-4 lg:px-6 flex-shrink-0 text-sm sm:text-base">
